...
# class Server(models):
#     '''服务器'''
#     asset = models.OneToOneField(verbose_name='归属', to='Asset', on_delete=models.CASCADE)
#
...
#     # 出场之后就会有的一个ip  可以通过这个ip 对刚刚出场的服务器进行一定的操作
...
#     '''硬盘'''
#     slot = models.CharField(verbose_name="槽位", max_length=8)
#     model = models.CharField(verbose_name="磁盘型号", max_length=32)
#     capacity = models.CharField(verbose_name="磁盘容量GB")
#     pd_type = models.CharField(verbose_name="磁盘类型", max_length=32)
#     server_obj = models.ForeignKey(to='Server', to_field='id', on_delete=models.CASCADE, related_name='disk')
#
#     class Meta:
